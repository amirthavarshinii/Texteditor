...
public class BasicDocument extends Document 
{
	...
	public int getNumWords()
	{
		...
		//Since this class has already extended the document class , there is no need to create new object t access the
		//methods in the document class , you can use it directly and if you use this. then also it will show 
		//all the methods that are in the document class 
   ...
   testCase(new BasicDocument("This is a test.  How many???  "
		...
		testCase(new BasicDocument("Lorem ipsum dolor sit amet, qui ex choro quodsi moderatius, nam dolores explicari forensibus ad."),
		         32, 15, 1);
	//testCase(new BasicDocument("Sentence"), 2, 1, 1,36.6);
	} 
