 ...
 */
class TrieNode {
	private HashMap<Character, TrieNode> children; // for linking each character to a trienode containing character or words
	private String text;  // Maybe omit for space
	private boolean isWord;// is this a word or not , may be its even a character 
